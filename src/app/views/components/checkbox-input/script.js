(() => {
  const checkboxInput = document.currentScript.parentElement;
  const control = checkboxInput.querySelector('.checkbox-input__control');
  const button = checkboxInput.querySelector('.button');
